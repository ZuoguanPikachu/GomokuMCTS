...
为解决面对复杂局面不堵”活三“的问题，修改了扩展子节点的算法。当出现”活三“、”死四“时，只扩展堵住”活三“、”死四“的节点。与此同时，减少模拟次数，使得等待的时间可以接受。

---

## C# Version

C#版本源码与exe在Release中可见

优化扩展子节点的算法：根据空白位附近棋子分布对该位置进行评分，取评分最高的前k个

优化roll out算法：不再纯随机，而是对评分进行softmax运算后，按概率进行roll out
